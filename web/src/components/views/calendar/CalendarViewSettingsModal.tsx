...
const CalendarViewSettingsModal = ({
    open,
    onOpenChange,
    view,
    workspaceId
}: CalendarViewSettingsModalProps) => {
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-neutral-800 rounded-lg shadow-xl p-6 w-[90vw] max-w-[500px] z-[1001] max-h-[85vh] overflow-y-auto">
                    <Dialog.Title className="text-xl font-semibold mb-4">
                        {t('views.calendarSettings') || 'Calendar Settings'}
                    </Dialog.Title>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex gap-3 justify-end mt-6">
                            ...
                            >
                                {visibilityMutation.isPending ? t('common.saving') || 'Saving...' : t('common.save')}
                            </button>
                        </div>
                    </form>
                </Dialog.Content>
